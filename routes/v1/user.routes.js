...
router.get('/notifications', authenticate, pagination(), userController.getNotifications);
...
router.get('/address', authenticate, pagination(), userController.getAddresses);
...
router.get('/payments', authenticate, pagination(), userController.getPaymentCards);
